...
client.on("ready", () => {
  ...
  const channel = client.channels.cache.get("1198961912906518689");

  if (!channel?.guild) {
    return console.error("Kanal veya bulunduğu sunucu bulunamadı.");
  }

  joinVoiceChannel({ // Buradan sonrası sana kalmış
